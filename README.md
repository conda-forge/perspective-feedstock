...
pixi add perspective
# for installing globally
pixi global install perspective
```
...
It is possible to list all of the versions of `perspective` available on your platform:
...
```
pixi search perspective --channel conda-forge
```
